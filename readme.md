...
docker exec -it demo_kafka-kafka-1 bash
...
kafka-console-producer --bootstrap-server localhost:29092 --topic topic1 --property "key.separator=-" --property "parse.key=true"

kafka-console-consumer --bootstrap-server localhost:29092 --topic topic1 --from-beginning --property "key.separator= - " --property "print.key=true"

How to view consumer groups
kafka-consumer-groups --bootstrap-server localhost:29092 --list

Указать что консюмер будет слушать только из определенной группы:
kafka-console-consumer --bootstrap-server localhost:29092 --topic test-topic --group console-consumer-32590 --property "key.separator= - " --property "print.key=true"

Command to describe all the Kafka topics.
kafka-topics --bootstrap-server localhost:29092 --topic topic1 --describe

Alter topic Partitions
kafka-topics --bootstrap-server localhost:29092 --alter --topic topic1 --partitions 40
